...
async def main():
  ...
  price_data = {}
  for stock in stocks:
    data = api.get_bars(stock, TimeFrame.Day, "2022-01-25", "2022-01-26", adjustment='raw').df
    price_data[stock] = dfToDict('2022-01-26', data)

  print(price_data["MRNS"]['open'])
  for entry in report.entries:
    recent_price = price_data[entry.stock]["close"]
    print(recent_price - entry.close_price)
